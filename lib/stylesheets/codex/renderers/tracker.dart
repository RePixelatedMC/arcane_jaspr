...
/// Codex Tracker renderer.
class CodexTracker extends StatelessComponent {
  final TrackerProps props;

  const CodexTracker(this.props, {super.key});
...
/// Codex Uptime Tracker renderer.
class CodexUptimeTracker extends StatelessComponent {
