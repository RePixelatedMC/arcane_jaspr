...
/// Codex OTP input component.
class CodexOtpInput extends StatelessComponent {
  final OtpInputProps props;

  const CodexOtpInput(this.props, {super.key});
        ...
        dom.div(
          ...
          [
            for (var i = 0; i < props.length; i++) ...[
              ...
              // Digit input
              dom.input(
                classes: 'codex-otp-digit ${hasError ? 'error' : ''} ${digits.length > i && digits[i].isNotEmpty ? 'filled' : ''}',
                type: props.obscure
