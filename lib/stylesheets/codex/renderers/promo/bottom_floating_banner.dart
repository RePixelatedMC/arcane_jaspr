...
/// Codex Bottom Floating Banner renderer.
///
/// Bottom floating banner that slides up with optional countdown timer.
class CodexBottomFloatingBanner extends StatefulComponent {
  final BottomFloatingBannerProps props;

  const CodexBottomFloatingBanner(this.props, {super.key});

  @override
  State<CodexBottomFloatingBanner> createState() =>
      _CodexBottomFloatingBannerState();
}

class _CodexBottomFloatingBannerState extends State<CodexBottomFloatingBanner> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'codex-bottom-floating-banner',
