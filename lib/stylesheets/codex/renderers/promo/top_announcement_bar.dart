...
/// Codex Top Announcement Bar renderer.
///
/// A thin sticky announcement bar at the top of the page with Codex styling:
/// - Glass effect with backdrop blur
/// - Accent-colored glows
/// - OLED-optimized dark background
class CodexTopAnnouncementBar extends StatefulComponent {
  final TopAnnouncementBarProps props;

  const CodexTopAnnouncementBar(this.props, {super.key});

  @override
  State<CodexTopAnnouncementBar> createState() =>
      _CodexTopAnnouncementBarState();
}

class _CodexTopAnnouncementBarState extends State<CodexTopAnnouncementBar> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'codex-top-announcement-bar',
              ...
              if (component.props.showCopyButton)
                dom.button(
                  styles: dom.Styles(raw: {
                    ...
                    'border-radius': 'var(--radius-sm)',
                    'color':
                        _codeCopied ? 'var(--success)' : 'var(--muted-foreground)',
                    'cursor': 'pointer',
