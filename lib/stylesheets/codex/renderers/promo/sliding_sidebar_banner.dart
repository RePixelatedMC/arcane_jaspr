...
/// Codex Sliding Sidebar Banner renderer.
///
/// A vertical sidebar banner that slides in from the edge.
class CodexSlidingSidebarBanner extends StatefulComponent {
  final SlidingSidebarBannerProps props;

  const CodexSlidingSidebarBanner(this.props, {super.key});

  @override
  State<CodexSlidingSidebarBanner> createState() =>
      _CodexSlidingSidebarBannerState();
}

class _CodexSlidingSidebarBannerState extends State<CodexSlidingSidebarBanner> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'codex-sliding-sidebar-banner',
