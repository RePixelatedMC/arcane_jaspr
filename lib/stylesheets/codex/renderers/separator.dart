...
class CodexSeparator extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    // Codex variant colors and thickness
  ...
  Component _buildLabeledSeparator(
    ...
    return dom.div(
      classes: 'codex-separator codex-separator-with-label',
      attributes: {
        'role': props.decorative ? 'none' : 'separator',
      },
      styles: dom.Styles(raw: {
  ...
  Component _buildVerticalSeparator(
    ...
    return dom.div(
      classes: 'codex-separator codex-separator-vertical',
      attributes: {
        'role': props.decorative ? 'none' : 'separator',
