...
/// Codex Fade Edge renderer.
class CodexFadeEdge extends StatelessComponent {
  final FadeEdgeProps props;

  const CodexFadeEdge(this.props, {super.key});
  ...
  Component build(BuildContext context) {
    ...
    final isHorizontal = props.direction == FadeDirection.left || props.direction == FadeDirection.right;
    ...
    return dom.div(
      classes: 'codex-fade-edge codex-fade-edge-${props.direction.name}',
