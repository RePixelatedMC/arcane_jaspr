...
/// Codex Input Dialog renderer.
class CodexInputDialog extends StatefulComponent {
  final InputDialogProps props;

  const CodexInputDialog(this.props, {super.key});

  @override
  State<CodexInputDialog> createState() => _CodexInputDialogState();
}

class _CodexInputDialogState extends State<CodexInputDialog> {
  late String _value;
  String? _error;
  ...
  Component build(BuildContext context) {
    ...
    return CodexDialog(
      DialogProps(
        ...
        content: [
          dom.div(
            classes: 'codex-input-dialog-content',
            ...
            [
              ...
              dom.div(
                classes: 'codex-input-dialog-input',
                styles: const dom.Styles(raw: {
                  'display': 'flex',
                  'flex-direction': 'column',
                  'gap': 'var(--space-2)',
