...
import '../../../core/props/floating_props.dart';

/// Codex Floating renderer.
///
/// Unified component for tooltip, popover, and hovercard patterns.
/// Implements the Codex design language with subtle glow effects.
class CodexFloating extends StatelessComponent {
  final FloatingProps props;

  const CodexFloating(this.props, {super.key});
  ...
  Component _buildCssTooltip() {
    return dom.div(
      classes: 'codex-floating-trigger',
      attributes: {
      ...
      [
        ...
        dom.div(
          classes: 'codex-floating codex-floating-tooltip',
  ...
  Component _buildStatefulFloating() {
    ...
    return dom.div(
      classes: 'codex-floating-container',
      styles: const dom.Styles(raw: {
        'position': 'relative',
  ...
  Component _buildFloatingContent() {
    ...
    return dom.div(
      classes: 'codex-floating-content',
      styles: dom.Styles(raw: {
        'position': 'absolute',
