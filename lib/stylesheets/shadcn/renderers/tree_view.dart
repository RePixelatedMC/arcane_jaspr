...
/// ShadCN Tree View renderer.
class ShadcnTreeView extends StatefulComponent {
  final TreeViewProps props;

  const ShadcnTreeView(this.props, {super.key});

  @override
  State<ShadcnTreeView> createState() => _ShadcnTreeViewState();
}

class _ShadcnTreeViewState extends State<ShadcnTreeView> {
