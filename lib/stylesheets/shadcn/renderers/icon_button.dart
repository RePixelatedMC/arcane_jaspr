...
class ShadcnIconButton extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    final (String dimension, String iconSize) = switch (props.size) {
      ComponentSize.sm => ('28px', '14px'),
      ComponentSize.md => ('36px', '18px'), // ShadCN: h-9 w-9
      ComponentSize.lg => ('44px', '22px'), // ShadCN: h-11 w-11
    };
    ...
    final (String bgColor, String fgColor) = switch (props.color) {
      ...
      ColorVariant.warning => ('var(--warning, #f59e0b)', 'var(--warning-foreground, #ffffff)'),
