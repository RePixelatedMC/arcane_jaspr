...
/// ShadCN Number Input renderer.
///
/// Renders a number input with increment/decrement controls
/// following ShadCN design patterns.
class ShadcnNumberInput extends StatelessComponent {
  final NumberInputProps props;

  const ShadcnNumberInput(this.props);
