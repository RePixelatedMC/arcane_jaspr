...
/// ShadCN SimpleForm renderer (stateful).
class ShadcnSimpleForm extends StatefulComponent {
  final SimpleFormProps props;

  const ShadcnSimpleForm(this.props, {super.key});

  @override
  State<ShadcnSimpleForm> createState() => _ShadcnSimpleFormState();
}

class _ShadcnSimpleFormState extends State<ShadcnSimpleForm> {
  ...
  Component _buildSuccessState() {
    return dom.div(
      classes: 'arcane-simple-form-success',
  ...
  Component _buildInlineForm() {
    ...
    return dom.div(
      classes: 'arcane-simple-form inline',
      styles: const dom.Styles(raw: {
        'display': 'flex',
        ...
        dom.div(
          ...
          [
            ...
            dom.button(
              ...
              classes: 'arcane-simple-form-button',
  ...
  Component _buildStackedForm() {
    ...
    return dom.div(
      classes: 'arcane-simple-form stacked',
      styles: dom.Styles(raw: {
        'display': 'flex',
        'flex-direction': 'column',
        'gap': 'var(--space-4)',
  ...
  Component _buildInput(
    ...
    if (field.type == SimpleFormFieldType.textarea) {
      return dom.textarea(
        classes: 'arcane-simple-form-input',
        attributes: {
