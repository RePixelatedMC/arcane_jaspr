...
class ShadcnFadeEdge extends StatelessComponent {
  final FadeEdgeProps props;

  const ShadcnFadeEdge(this.props, {super.key});
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'arcane-fade-edge arcane-fade-edge-${props.direction.name}',
