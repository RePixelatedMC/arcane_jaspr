...
/// ShadCN Marquee renderer.
class ShadcnMarquee extends StatelessComponent {
  final MarqueeProps props;

  const ShadcnMarquee(this.props, {super.key});

  @override
  Component build(BuildContext context) {
    final effectiveGap = props.gap ?? '1.5rem';
    final marqueeId = props.id ?? 'arcane-marquee-${hashCode}';
    final isReverse = props.direction == MarqueeDirection.right;
    final animationName = isReverse
        ? 'arcane-marquee-scroll-reverse-$marqueeId'
        : 'arcane-marquee-scroll-$marqueeId';

    return dom.div(
      classes: 'arcane-marquee',
