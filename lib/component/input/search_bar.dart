          ...
          children: [
            ...
            input(
              ...
              styles: const Styles(raw: {
                ...
                'border': '1px solid var(--border, var(--arcane-outline))',
                'background': 'var(--input, var(--arcane-surface))',
                'color': 'var(--foreground, var(--arcane-on-surface))',
                'outline': 'none',
            ...
            ArcaneDiv(
              styles: const ArcaneStyleData(
                ...
                raw: {
                  'color': 'var(--muted-foreground, var(--arcane-on-surface-variant))',
                },
              ),
              children: [
        ...
        if (component.showDropdown)
          div(
            ...
            styles: Styles(raw: {
              ...
              'z-index': '1000',
              'margin-top': '4px',
              'background': 'var(--popover, var(--arcane-surface))',
              'border': '1px solid var(--border, var(--arcane-outline))',
              'border-radius': 'var(--radius, 8px)',
