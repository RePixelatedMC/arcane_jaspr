...
///
/// Characteristics:
/// - Rounded corners (larger radius than Codex) - friendly/approachable look
/// - Minimal shadows (border-focused)
/// - No glass effects (clean, solid surfaces)
/// - Google Fonts (Inter)
/// - Quick, subtle animations
/// - Circular toggle thumbs (standard ShadCN look)
...
class ShadcnStyleSheet extends ArcaneStyleSheet {
  ...
  InteractiveTokens get interactiveTokens => const InteractiveTokens(
        ...
        hoverShadow: ShadowIntensity.subtle,
        borderWeight: BorderWeight.standard,
        useGradients: false,
        hoverAnimation: AnimationPreset.scaleSubtle,
        focusRingWidth: '2px',
        focusRingOffset: '2px',
      );
  ...
  InputTokens get inputTokens => const InputTokens(
        shape: ComponentShape.rounded,
        borderWeight: BorderWeight.standard,
        focusShadow: ShadowIntensity.subtle,
  ...
  IndicatorTokens get indicatorTokens => const IndicatorTokens(
        // Checkbox: Rounded
        checkboxShape: ComponentShape.rounded,
        checkboxBorder: BorderWeight.standard,
        // Radio: Circular (standard ShadCN)
        radioShape: ComponentShape.circle,
        radioBorder: BorderWeight.standard,
        // Toggle: Pill track, circular thumb (standard ShadCN)
        toggleTrackShape: ComponentShape.pill,
        toggleThumbShape: ComponentShape.circle,
        thumbShadow: true,
        // Toggle colors: Background-colored thumb (matches track when OFF, contrast when ON)
        thumbOnColor: 'var(--arcane-background)',
        thumbOffColor: 'var(--arcane-background)',
        trackOnColor: 'var(--arcane-primary)',
        trackOffColor: 'var(--arcane-input)',
        // No gradients
        useGradientFill: false,
        checkAnimation: AnimationPreset.scaleSubtle,
      );
