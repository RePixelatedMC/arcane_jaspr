import 'package:arcane_jaspr/core/props/scaffold_props.dart';
import 'package:arcane_jaspr/flutter.dart';
import 'package:arcane_jaspr/web.dart' as dom;

export 'package:arcane_jaspr/core/props/scaffold_props.dart';

abstract class LayoutRenderers with ScaffoldRendererContract {
  const LayoutRenderers();
}

class DefaultLayoutRenderers extends LayoutRenderers {
  ...
  static Widget _header(ArcaneScaffoldProps props) => dom.header(
    ...
    <Widget>[
      if (props.title != null)
        dom.div(
          ...
          <Widget>[Widget.text(props.title!)],
        ),
