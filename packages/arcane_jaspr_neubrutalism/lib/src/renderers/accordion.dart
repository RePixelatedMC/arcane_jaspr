...
class NeubrutalismAccordion extends StatelessComponent {
  final AccordionProps props;

  const NeubrutalismAccordion(this.props, {super.key});

  @override
  Component build(BuildContext context) {
    return dom.div(
      classes: 'neubrutalism-accordion faq-container',
  ...
  Component _buildItem(AccordionItemProps item, int index, bool defaultOpen) {
    final String accentColor =
        item.accentColor ?? props.defaultAccentColor ?? 'var(--nb-accent, var(--primary))';
