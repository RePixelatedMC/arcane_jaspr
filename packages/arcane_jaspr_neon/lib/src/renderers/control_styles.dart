...
class NeonControlStyles {
  ...
  static Map<String, String> buttonBase(bool isDisabled) => <String, String>{
    ...
    'gap': '0.625rem',
    'white-space': 'nowrap',
    'border-radius': 'var(--neon-radius-control, var(--radius-sm))',
    'clip-path':
        'polygon(0 var(--neon-cut-sm, 0.5rem), var(--neon-cut-sm, 0.5rem) 0, 100% 0, 100% calc(100% - var(--neon-cut-sm, 0.5rem)), calc(100% - var(--neon-cut-sm, 0.5rem)) 100%, 0 100%)',
    ...
    'box-shadow': 'var(--neon-inset-highlight, inset 0 1px 0 rgba(255,255,255,0.08))',
  };
