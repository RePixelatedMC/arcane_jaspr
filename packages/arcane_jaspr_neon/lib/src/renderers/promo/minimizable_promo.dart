...
class NeonMinimizablePromo extends StatefulComponent {
  final MinimizablePromoProps props;

  const NeonMinimizablePromo(this.props, {super.key});

  @override
  State<NeonMinimizablePromo> createState() => _NeonMinimizablePromoState();
}

class _NeonMinimizablePromoState extends State<NeonMinimizablePromo> {
