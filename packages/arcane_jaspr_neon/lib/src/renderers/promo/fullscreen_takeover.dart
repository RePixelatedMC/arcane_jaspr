...
class NeonFullscreenTakeover extends StatefulComponent {
  ...
  const NeonFullscreenTakeover(this.props, {super.key});

  @override
  State<NeonFullscreenTakeover> createState() =>
      _NeonFullscreenTakeoverState();
}

class _NeonFullscreenTakeoverState extends State<NeonFullscreenTakeover> {
