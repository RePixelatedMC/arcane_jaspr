...
/// Neon Corner Promo Toast renderer.
///
/// A corner toast-style promo notification that slides in from a corner.
class NeonCornerPromoToast extends StatefulComponent {
  final CornerPromoToastProps props;

  const NeonCornerPromoToast(this.props, {super.key});

  @override
  State<NeonCornerPromoToast> createState() => _NeonCornerPromoToastState();
}

class _NeonCornerPromoToastState extends State<NeonCornerPromoToast> {
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      classes: 'neon-corner-promo-toast',
      styles: dom.Styles(
        raw: {
          'position': 'fixed',
          ...positionStyles,
          ...
          // Neon: accent glow
          'box-shadow':
              '0 0 30px color-mix(in srgb, var(--neon-accent) 20%, transparent), 0 20px 40px -12px rgba(0, 0, 0, 0.4)',
          'padding': '1.25rem',
        },
      ),
      [
          ...
          dom.a(
            ...
            styles: const dom.Styles(
              raw: {
                ...
                'box-shadow': '0 14px 15px color-mix(in srgb, var(--neon-accent) 30%, transparent)',
              },
            ),
