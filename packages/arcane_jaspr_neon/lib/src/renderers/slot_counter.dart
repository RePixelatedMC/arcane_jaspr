...
class NeonSlotCounter extends StatefulComponent {
  ...
  const NeonSlotCounter(this.props, {super.key});

  @override
  State<NeonSlotCounter> createState() => _NeonSlotCounterState();
}

class _NeonSlotCounterState extends State<NeonSlotCounter> {
...
class NeonSlotCounterRow extends StatelessComponent {
  ...
  const NeonSlotCounterRow(this.props, {super.key});

  @override
  Component build(BuildContext context) {
    return dom.div(
      classes: 'neon-slot-counter-row',
      styles: dom.Styles(
        raw: {
          'display': 'flex',
      ...
      [for (final counter in props.counters) NeonSlotCounter(counter)],
    );
  }
}
...
class NeonSlotCounterCard extends StatelessComponent {
  ...
  const NeonSlotCounterCard(this.props, {super.key});
