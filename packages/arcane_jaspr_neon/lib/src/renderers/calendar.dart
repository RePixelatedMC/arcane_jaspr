...
class NeonCalendar extends StatelessComponent {
  ...
  bool _isSelected(DateTime date) =>
      props.selected != null && _isSameDay(date, props.selected!);
  ...
  Component build(BuildContext context) {
    ...
    return dom.div(
      ...
      [
        ...
        if (props.showToday)
          dom.button(
            classes: 'neon-calendar-today-btn',
      ...
      styles: dom.Styles(
        raw: {
          ...
          'background': isSelected
              ...
              : isInRange
              ? 'color-mix(in srgb, var(--neon-accent) 8%, var(--neon-surface-1))'
              : 'transparent',
          'font-size': '13px',
