...
class ShadcnTimePicker extends StatelessComponent {
  ...
  Map<String, String> get _sizeStyles => switch (props.size) {
    ComponentSize.sm => {'height': '32px', 'fontSize': '0.875rem'},
    ComponentSize.md => {'height': '40px', 'fontSize': '0.875rem'},
    ComponentSize.lg => {'height': '48px', 'fontSize': '1rem'},
  };
        ...
        if (props.isOpen)
          dom.div(
            ...
            [
              ...
              dom.div(
                styles: const dom.Styles(
                  raw: {'display': 'flex', 'gap': 'var(--space-4)'},
                ),
                [
                  // Hours column
                  _buildTimeColumn(
                  ...
                  if (!props.use24Hour)
                    dom.div(
                      ...
                      [
                        ...
                        dom.button(
                          classes:
                              'arcane-time-picker-option ${!props.isPM ? 'selected' : ''}',
                          type: dom.ButtonType.button,
                          styles: dom.Styles(
                            raw: {
                              'padding': '0.5rem 1rem',
