        ...
        ArcaneNav(
          ...
          children: [
            ...
            _buildCollapsibleSection('Inputs', ArcaneIcon.settings(size: IconSize.sm), [
              ...
              _buildNavItem(label: 'ArcaneDropdownMenu', href: '/docs/inputs/arcane-dropdown-menu'),
            ...
            _buildCollapsibleSection('Feedback', ArcaneIcon.bell(size: IconSize.sm), [
              ...
              _buildNavItem(label: 'ArcaneInputDialog', href: '/docs/feedback/arcane-input-dialog'),
