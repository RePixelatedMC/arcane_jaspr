...
Plan: Comprehensive arcane_jaspr Documentation Site
     ...
     - arcane_neon_web/lib/components/docs_sidebar.dart - Navigation structure
     - arcane_neon_web/lib/components/code_block.dart - Code display (NEW)
     - arcane_neon_web/lib/components/component_demo.dart - Demo wrapper (NEW)
     - arcane_neon_web/lib/components/props_table.dart - Props table (NEW)
     - arcane_neon_web/lib/layouts/arcane_docs_layout.dart - Page layout
     - arcane_neon_web/web/styles.css - Code block styling
     - 100+ content markdown files in arcane_neon_web/content/docs/
